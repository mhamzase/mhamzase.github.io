...
-------------------------- */
  ...
  $(document).ready(function () {
    ...
    emailjs.init("HnbK81xyF48eje1E7"); // Replace with your actual public key
    ...
    $("#contact-form").on("submit", function (e) {
      ...
      var $msg = $form.find('textarea[name="form-message"]');
      ...
      if ($msg.val().trim() === "") {
        showFieldError($msg, "Please enter your message.");
        isValid = false;
      }
      ...
      var templateParams = {
        ...
        reply_to: $email.val().trim(), // This sets the Reply-To header
        message: $msg.val().trim(),
      };

      // Send email
      emailjs
        .send("service_69a6cx9", "template_lq8h51m", templateParams)
    ...
    function showFieldError($field, message) {
      ...
      $field.after(
        '<div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>' +
          message +
          "</div>",
      );
    }
    ...
    function showAlert(type, text) {
      ...
      var html =
        '<div class="alert ' +
        alertClass +
        ' d-flex align-items-center justify-content-center fade show" role="alert">' +
        '<i class="fas ' +
        icon +
        ' me-2"></i>' +
        "<span>" +
      ...
      setTimeout(function () {
        $("#form-message .alert").fadeOut("slow", function () {
          $(this).remove();
        });
      }, 5000);
    }
